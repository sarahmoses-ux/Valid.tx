    ...
    >
      <div className="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="font-body-md text-body-sm text-on-surface-variant mt-2">Discovered activity is indexed from source chains. Verified activity is backed by an Attestcoin proof.</p>
        </div>
        <div className="inline-flex self-start items-center gap-2 px-3 py-1 rounded-lg border border-secondary/30 bg-secondary/10 text-secondary text-label-md uppercase tracking-wider whitespace-nowrap">
          <span className="material-symbols-outlined text-[14px]">verified</span>Attestcoin Verified
        </div>
      </div>
